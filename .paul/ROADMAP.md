...
Status: 🚧 In Progress — 4 of 8 phases complete. v70-01 (image-chart support) + v70-02 (recordings data model) + v70-03 (per-track media affordances) + v70-04 (doc upload + text extraction) ✅ COMPLETE 2026-05-14. Next: v70-05 Gemini structured extraction (Wave 3).
