...
| 3 (sequential) | v60-06 | Dashboard reader migration + 15-setlist backfill (`migration_snapshots/{setlistId}` rollback collection) | 🚧 In Progress — v60-06-01..07 LOOP COMPLETE (v60-06-01..06 2026-05-12 / v60-06-07 2026-05-13). Client reader inventory COMPLETE (Dexie-aware 3-branch + Dexie bulk + Web-SDK direct-fetch 2-branch). **Server reader spine COMPLETE** (v60-06-07 matrix/route.ts; +3 LOC net; auto-fixed TS2352 spread-narrowing variant of v60-06-06 pattern via `as unknown as Setlist`). **v60-07 writer strip UNBLOCKED.** Only v60-06-08 backfill remains. Aggregate: +263 LOC net cumulative + 49 hook + 205 test; HFG 0/3 held throughout. |
