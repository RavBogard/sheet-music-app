...
| v50-05 | Spreadsheet editor UI (cutover) | 4/5 (01 build ✓ • 02 cutover ✓ • 03 multi-select+AlertDialog ✓ • 04 iPad+ContextMenu ✓ • 05 mobile+WCAG+undo) | 🚧 In Progress | - |
...
*Last updated: 2026-04-26 (v50-05-04 closed: iPad/pointer-coarse Sheet swap across 6 sites + 44px touch targets + right-click ContextMenu + 500ms long-press for touch shipped on prod; +17 new vitest cases; v50-05-05 mobile + WCAG AA + Undo next — last plan in v50-05)*
