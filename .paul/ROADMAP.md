...
| 3 (sequential) | v60-04 | Server-side reader migration (publish / print / email / scheduling) via single `getTracksForSetlist` helper | 🚧 In Progress — v60-04-01 LOOP COMPLETE 2026-05-12 (helper + page.tsx reroute + publish-route migration + 3-test emulator coverage; single combined commit; +18 LOC net production; HFG 0/3 held). v60-04-02 (print/public + print/personal) + v60-04-03 (email-packets + resend-email) pending. |
