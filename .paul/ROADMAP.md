...
Status: 🚧 In Progress · Phases: 1 of 5 (v11.2-01 ✅) · Source: Brothers Lazaroff MCP + Perform **stress-test report** (2026-06-09; BL tenant only, CRC untouched, all test data cleaned — tenant verified empty post-run).
...
| v11.2-02 | publish-audience org scoping — BUG-9 [P1 · VERIFY-FIRST] | TBD | Not started | - |
