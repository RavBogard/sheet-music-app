...
| 3 (sequential) | v60-06 | Dashboard reader migration + 15-setlist backfill (`migration_snapshots/{setlistId}` rollback collection) | 🚧 In Progress — v60-06-01 + v60-06-02 + v60-06-03 + v60-06-04 LOOP COMPLETE 2026-05-12 (trackCount + songCount + fileIds denormalization + SetlistCards/use-upcoming-prep + bulk Dexie hook `useDexieTracksForSetlists` powering PrepRecommendations + UpcomingTimeline.ExpandedTrackList; +182 LOC net cumulative + 49 hook + 114 test; HFG 0/3 held). Every dashboard read site now routes through canonical sources — v60-07 writer removal unblocked. ~3 plans remaining (v60-06-05 SetlistDrawer next). |
