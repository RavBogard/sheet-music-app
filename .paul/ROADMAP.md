...
| 3 (sequential) | v60-06 | Dashboard reader migration + 15-setlist backfill (`migration_snapshots/{setlistId}` rollback collection) | 🚧 In Progress — v60-06-01 + v60-06-02 LOOP COMPLETE 2026-05-12 (trackCount + songCount + fileIds denormalization; +147 LOC net cumulative; HFG 0/3 held); v60-06-03 PLAN created (SetlistCards + use-upcoming-prep readers). ~4 plans remaining. |
