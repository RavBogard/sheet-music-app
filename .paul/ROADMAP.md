...
| 3 (sequential) | v60-06 | Dashboard reader migration + 15-setlist backfill (`migration_snapshots/{setlistId}` rollback collection) | 🚧 In Progress — v60-06-01 + v60-06-02 + v60-06-03 LOOP COMPLETE 2026-05-12 (trackCount + songCount + fileIds denormalization + SetlistCards/use-upcoming-prep reader migration; +156 LOC net cumulative; HFG 0/3 held). ~4 plans remaining (v60-06-04 title-aware readers next). |
