...
| v50-05 | Spreadsheet editor UI (cutover) | 3/5 (01 build ✓ • 02 cutover ✓ • 03 multi-select+AlertDialog ✓ • 04 iPad+ContextMenu • 05 mobile+WCAG+undo) | 🚧 In Progress | - |
...
*Last updated: 2026-04-26 (v50-05-03 closed: multi-select + BatchActionBar + AlertDialog swap-in shipped on prod; +44 new vitest cases; v50-05-04 iPad/touch + ContextMenu next)*
