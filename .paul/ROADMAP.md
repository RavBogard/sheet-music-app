...
**🚧 v11.4 — Publish & Notify (D8)** (OPEN 2026-06-10 · 4 phases · **CONTENT COMPLETE 4/4 2026-06-11 → ready for `/paul:complete-milestone`**)
Status: ✅ CONTENT COMPLETE · Phases: **4 of 4 complete** · **Spec backbone:** `docs/ACCESS-POLICY.md` §"Publish & notify (D8, ratified 2026-06-10)" — this milestone *implements* the already-ratified D8 decision (bump oracle → v0.4 when it ships; retire the "Until D8 ships, invariant 3 stands as-is" note) · **Context:** derived via `/paul:discuss-milestone` 2026-06-10 (`MILESTONE-CONTEXT.md`, consumed).
