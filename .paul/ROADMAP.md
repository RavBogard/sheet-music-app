...
| 3 (sequential) | v60-04 | Server-side reader migration (publish / print / email / scheduling) via single `getTracksForSetlist` helper | ✅ LOOP COMPLETE — PENDING-UAT (2026-05-12, 3 plans: `f03dcb1` v60-04-01 helper + page.tsx + publish + emulator coverage / `1e1cdc4` v60-04-02 print/public + print/personal / `[v60-04-03 SHA]` email-packets + resend-email + latent songs type fix; aggregate +39 LOC net production across 7 files; 3 emulator-backed tests; HFG counter 0/3 held throughout; Wave 3 server spine complete; v60-07 writer strip now safe to plan) |
| 3 (sequential) | v60-05 | Editor + perform-view reader migration | ⚪ Not started |
| 3 (sequential) | v60-06 | Dashboard reader migration + 15-setlist backfill (`migration_snapshots/{setlistId}` rollback collection) | ⚪ Not started |
| 3 (sequential) | v60-07 | Embedded-array writer removal + immediate `FieldValue.delete` strip | ⚪ Not started |
