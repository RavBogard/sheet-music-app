...
| 3 (sequential) | v60-06 | Dashboard reader migration + 15-setlist backfill (`migration_snapshots/{setlistId}` rollback collection) | 🚧 In Progress — v60-06-01 LOOP COMPLETE 2026-05-12 (HeroCard + CompactSetlistRow trackCount migration; +3 LOC net; HFG 0/3 held). ~6 plans remaining. |
