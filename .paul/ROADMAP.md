...
| 3 (sequential) | v60-04 | Server-side reader migration (publish / print / email / scheduling) via single `getTracksForSetlist` helper | 🚧 In Progress — v60-04-01 LOOP COMPLETE 2026-05-12 (`f03dcb1`); v60-04-02 LOOP COMPLETE 2026-05-12 (print/public + print/personal drop-in; +8 LOC net; HFG 0/3 held); v60-04-03 (email-packets + resend-email) pending. |
