...
|------|-------|-------|--------|
| 0 (foundation) | v70-01 | **Image-chart support** (PNG / JPEG / HEIC) — upload route ALLOWED_TYPES extended; chart viewer branches PDF→pdfjs vs image→`<img>`; print pipeline embeds images; AI chord detection + transposition DISABLED for image charts with explanation tooltip | ✅ Wave 0 slice complete 2026-05-14 (v70-01-01 LOOP CLOSED @ `1c4f9f4` — PENDING-UAT AC-3+AC-4; print embed deferred to v70-01-02 by design) |
