...
| 3 (sequential) | v60-06 | Dashboard reader migration + 15-setlist backfill (`migration_snapshots/{setlistId}` rollback collection) | 🚧 In Progress — v60-06-01..05 LOOP COMPLETE 2026-05-12 (trackCount + songCount + fileIds denormalization + SetlistCards/use-upcoming-prep + bulk Dexie hook + PrepRecommendations + UpcomingTimeline + SetlistDrawer click-time read; +199 LOC net cumulative + 49 hook + 114 test; HFG 0/3 held). Upcoming-perf-view flow fully canonical-source-first. ~2 plans remaining (v60-06-06 TemplatesSection, v60-06-07 matrix/route.ts; v60-06-08 backfill). |
