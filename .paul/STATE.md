...
v50-07-05:     ○ ──▶ ○ ──▶ ○     [Next — Sentry alarms on save-path failures + manual UAT prep + ship-to-band checklist (FINAL plan before v5.0 milestone close)]
```
