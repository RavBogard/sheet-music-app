...
Milestone: 🚧 v5.1 — Editor UX Polish (band-onboarding gate) — 0 of 4 phases complete. Synthesized from /paul:discuss-milestone session 2026-04-27 + late add (editor readability/visual-hierarchy) → 4 phases. Tablet-first. /ui-ux-pro-max BLOCKING per SPECIAL-FLOWS.md for every phase.
Phase: v51-01 of 4 (Picker rework — all 6 dropdown sites) — Not started; ready to plan.
