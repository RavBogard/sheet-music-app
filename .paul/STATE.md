...
v50-07-04:     ✓ ──▶ ○ ──▶ ○     [PLAN created — kitchen-sink (fast-check ≥100 iterations) + minimal Playwright lazy-hydration smoke; 1 decision checkpoint blocks APPLY]
v50-07-05:     ○ ──▶ ○ ──▶ ○     [Sentry alarms on save-path failures + manual UAT prep + ship-to-band checklist (final)]
```
