...
v50-07-05:     ✓ ──▶ ✓ ──▶ ○     [APPLY shipped — Sentry alarms wired at 6 sites via new sentry-capture helper (1474/1474, +6 tests); UAT-PLAN.md (15-item smoke + 7 scenarios + coverage map) + SHIP-CHECKLIST.md (deploy verification + 1-page band onboarding + first-week monitoring playbook with rollback) authored; commit 9987bc5; UNIFY pending. FINAL before v5.0 milestone close]
```
