...
- [x] **Phase 7: Dashboard UX Consolidation (Public Hero Cards)** - Break the `<NextServiceCard>` out of the `isMember` gate so all users, including guests, have instant access to upcoming services.
