 ...
 * silently stop unpacking the checker, and `--strict` would go back to this repo
 * agreeing with itself while still passing — nothing else in the suite would
 * notice. These lock the reason each name is on the list.
 */
