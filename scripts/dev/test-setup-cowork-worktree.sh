#!/usr/bin/env bash
# scripts/dev/test-setup-cowork-worktree.sh
#
...
# and in seconds. Mirrors scripts/dev/test-setup-coord-worktree.sh.
#
# Scenarios:
...
#
# Usage:
#   bash scripts/dev/test-setup-cowork-worktree.sh

set -uo pipefail

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
SCRIPTS_DIR="$(cd "$SCRIPT_DIR/.." && pwd)"
LIB="$SCRIPTS_DIR/lib/cowork-warm-worktree.sh"
SETUP="$SCRIPTS_DIR/setup-cowork-worktree.sh"
COORD_SETUP="$SCRIPTS_DIR/setup-coord-worktree.sh"
