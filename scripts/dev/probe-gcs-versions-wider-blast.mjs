 ...
 *
 * Usage:
 *   node scripts/dev/probe-gcs-versions-wider-blast.mjs                    # window defaults below
 *   node scripts/dev/probe-gcs-versions-wider-blast.mjs --since <iso> --until <iso>
 *   node scripts/dev/probe-gcs-versions-wider-blast.mjs --ids id1,id2,id3  # bypass sync_runs
 *
 * Defaults:
