...
//
// Run with:
//   npx tsx scripts/migrations/2026-04-27/scrub-livestate.ts --dry-run     (default-safe; reports affected)
//   npx tsx scripts/migrations/2026-04-27/scrub-livestate.ts --apply       (executes; rollback snapshots written)
//   npx tsx scripts/migrations/2026-04-27/scrub-livestate.ts --rollback    (restores from snapshots)
//   npx tsx scripts/migrations/2026-04-27/scrub-livestate.ts --force       (re-runs even if marker present)
//   npx tsx scripts/migrations/2026-04-27/scrub-livestate.ts --help
...
Usage:
  npx tsx scripts/migrations/2026-04-27/scrub-livestate.ts                Dry-run (default; safe)
  npx tsx scripts/migrations/2026-04-27/scrub-livestate.ts --dry-run      Same as default
  npx tsx scripts/migrations/2026-04-27/scrub-livestate.ts --apply        Execute scrub + write rollback snapshots
  npx tsx scripts/migrations/2026-04-27/scrub-livestate.ts --apply --force  Re-run even if marker present
  npx tsx scripts/migrations/2026-04-27/scrub-livestate.ts --rollback     Restore liveState from snapshots
  npx tsx scripts/migrations/2026-04-27/scrub-livestate.ts --help         Show this help
