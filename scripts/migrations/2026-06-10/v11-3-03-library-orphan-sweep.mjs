...
//
// USAGE:
//   node scripts/migrations/2026-06-10/v11-3-03-library-orphan-sweep.mjs            (dry-run — print only)
//   node scripts/migrations/2026-06-10/v11-3-03-library-orphan-sweep.mjs --apply    (delete orphans + best-effort Storage)
//
