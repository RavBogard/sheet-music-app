...
//
// Run: node scripts/migrations/2026-05-22/heal-eventdate-types.mjs            (dry-run, default)
//      node scripts/migrations/2026-05-22/heal-eventdate-types.mjs --apply    (write Timestamps)
