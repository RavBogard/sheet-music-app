...
// modify them.
//
// Run with: npx tsx scripts/migrations/2026-05-13/backfill-shortcuts-songs.ts [--dry-run|--apply|--force|--help]
//
...
Usage:
  npx tsx scripts/migrations/2026-05-13/backfill-shortcuts-songs.ts --dry-run    Enumerate missing songs/* docs; no writes
  npx tsx scripts/migrations/2026-05-13/backfill-shortcuts-songs.ts              APPLY: write missing docs (marker prevents re-run)
  npx tsx scripts/migrations/2026-05-13/backfill-shortcuts-songs.ts --force      Re-run even if marker exists
  npx tsx scripts/migrations/2026-05-13/backfill-shortcuts-songs.ts --help       Show this help
