...
//
// Run with: npx tsx scripts/migrations/2026-05-13/backfill-tracks-v60.ts [--dry-run|--apply|--rollback|--force|--help]
//
...
Usage:
  npx tsx scripts/migrations/2026-05-13/backfill-tracks-v60.ts              Dry-run (default; read-only)
  npx tsx scripts/migrations/2026-05-13/backfill-tracks-v60.ts --dry-run    Explicit dry-run
  npx tsx scripts/migrations/2026-05-13/backfill-tracks-v60.ts --apply      Apply (writes to PRODUCTION Firestore)
  npx tsx scripts/migrations/2026-05-13/backfill-tracks-v60.ts --rollback   Restore from migration_snapshots and delete top-level tracks
  npx tsx scripts/migrations/2026-05-13/backfill-tracks-v60.ts --force      Re-run apply even if marker exists, OR rollback without prior apply marker
  npx tsx scripts/migrations/2026-05-13/backfill-tracks-v60.ts --help       Show this help
