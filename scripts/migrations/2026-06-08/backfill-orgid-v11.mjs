 ...
 *
 * Sibling of `scripts/migrations/2026-05-24/backfill-drive-id-on-library-index.mjs` — same auth path
 ...
 *
 * Usage:
 *   node scripts/migrations/2026-06-08/backfill-orgid-v11.mjs            # DRY-RUN (read-only)
 *   node scripts/migrations/2026-06-08/backfill-orgid-v11.mjs --apply    # real run
 *
