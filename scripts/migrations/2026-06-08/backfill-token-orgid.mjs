 ...
 *
 * Sibling of `scripts/migrations/2026-06-08/backfill-orgid-v11.mjs` — same two-path auth, same
 ...
 *   2. DRY-RUN first:  node scripts/migrations/2026-06-08/backfill-token-orgid.mjs
 *      INSPECT the report — `scanned` should equal the live token count.
 *   3. Real run:        node scripts/migrations/2026-06-08/backfill-token-orgid.mjs --apply
 *   4. Confirm:         node scripts/migrations/2026-06-08/backfill-token-orgid.mjs   → wouldStamp:0
 ...
 *
 * Usage:
 *   node scripts/migrations/2026-06-08/backfill-token-orgid.mjs            # DRY-RUN (read-only)
 *   node scripts/migrations/2026-06-08/backfill-token-orgid.mjs --apply    # real run
 */
