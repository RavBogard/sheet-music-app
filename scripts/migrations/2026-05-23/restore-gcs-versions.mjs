 ...
 *
 * Tier-0 ops tool. Sibling of `scripts/dev/probe-gcs-versions.mjs`. Reads the
 ...
 *
 * Usage:
 *   node scripts/migrations/2026-05-23/restore-gcs-versions.mjs                            # DRY-RUN, default inventory
 *   node scripts/migrations/2026-05-23/restore-gcs-versions.mjs --apply                    # real run (Daniel only)
 *   node scripts/migrations/2026-05-23/restore-gcs-versions.mjs --from <path>              # DRY-RUN, alt inventory
 *   node scripts/migrations/2026-05-23/restore-gcs-versions.mjs --from <path> --apply      # real run on alt inventory
 *
