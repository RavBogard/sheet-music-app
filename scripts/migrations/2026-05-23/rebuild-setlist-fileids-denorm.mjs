 ...
 * `scripts/migrations/2026-05-23/restore-gcs-versions.mjs` / `scripts/dev/probe-gcs-versions-wider-blast.mjs`
 ...
 *
 * Usage:
 *   node scripts/migrations/2026-05-23/rebuild-setlist-fileids-denorm.mjs            # DRY-RUN
 *   node scripts/migrations/2026-05-23/rebuild-setlist-fileids-denorm.mjs --apply    # real run
 *
