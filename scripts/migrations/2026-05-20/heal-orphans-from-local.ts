...
//
// Run with:
//   npx tsx scripts/migrations/2026-05-20/heal-orphans-from-local.ts --dir "<LOCAL_BATCH_FOLDER>" \
...
async function main(): Promise<void> {
    ...
    if (!dir) {
        console.error(
            "Usage: npx tsx scripts/migrations/2026-05-20/heal-orphans-from-local.ts --dir <folder> [--manifest <json>] [--out <json>]",
        )
        process.exit(2)
    }
