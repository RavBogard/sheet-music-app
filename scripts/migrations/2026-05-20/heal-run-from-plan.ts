...
//
// Run (dry-run):
//   npx tsx scripts/migrations/2026-05-20/heal-run-from-plan.ts --dir "C:\Users\dsbog\OneDrive\Desktop\993122D_COMPLETE_SHIREINU\993122D COMPLETE SHIREINU\INDIVIDUAL PDFs"
// Run (commit, Daniel):
//   npx tsx scripts/migrations/2026-05-20/heal-run-from-plan.ts --dir "<folder>" --commit --bearer crl_live_xxx
//
