...
// Run with: npx tsx scripts/migrations/2026-04-26/migrate-v50.ts [--dry-run|--force|--rollback|--help]
...
Usage:
  npx tsx scripts/migrations/2026-04-26/migrate-v50.ts                Apply migration
  npx tsx scripts/migrations/2026-04-26/migrate-v50.ts --dry-run      Enumerate planned changes; no writes
  npx tsx scripts/migrations/2026-04-26/migrate-v50.ts --force        Re-run even if marker exists
  npx tsx scripts/migrations/2026-04-26/migrate-v50.ts --rollback     Restore from migrations/v50/snapshot/*
  npx tsx scripts/migrations/2026-04-26/migrate-v50.ts --help         Show this help
