 ...
 *
 * Sibling-of:
 *   - `scripts/migrations/2026-05-24/backfill-drive-id-on-library-index.mjs` (coder-3 `0c0392a72`)
 *     — closest mirror in shape (same env loader, same DRY-RUN/--apply, same
 *     audit-trail JSON output).
 *   - `scripts/migrations/2026-05-23/rebuild-setlist-fileids-denorm.mjs` (coder-2 `8ddcca1c5`) —
 *     original precedent.
 *
 * ## Behavior
 *
 ...
 * ## Usage
 *
 *   node scripts/migrations/2026-05-25/backfill-library-normalizedname.mjs            # DRY-RUN
 *   node scripts/migrations/2026-05-25/backfill-library-normalizedname.mjs --apply    # real run
 *
 * ## Auth
 *
