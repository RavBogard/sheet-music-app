...
(`scripts/migrations/2026-05-25/restamp-pdf-stem-drift.mjs` ~L131).
...
node scripts/migrations/2026-05-25/restamp-pdf-stem-drift.mjs > .paul/ops/pdf-stem-drift-restamp/DRY-RUN-001.log 2>&1

# HEADS-UP to supervisor with summary block. Supervisor relays GO.

# Phase 2: APPLY (single-owner; GO-gated)
node scripts/migrations/2026-05-25/restamp-pdf-stem-drift.mjs --apply > .paul/ops/pdf-stem-drift-restamp/APPLY-001.log 2>&1

# Phase 3: RE-DRY for idempotency
node scripts/migrations/2026-05-25/restamp-pdf-stem-drift.mjs > .paul/ops/pdf-stem-drift-restamp/REDRY-001.log 2>&1
```
...
- `scripts/migrations/2026-05-25/backfill-library-normalizedname.mjs` — same shape, opposite
