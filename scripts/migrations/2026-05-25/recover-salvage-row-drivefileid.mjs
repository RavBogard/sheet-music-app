 ...
 * `scripts/migrations/2026-05-24/backfill-drive-id-on-library-index.mjs` (W4-2 narrow Option-A
 ...
 *
 * Usage:
 *   node scripts/migrations/2026-05-25/recover-salvage-row-drivefileid.mjs            # DRY-RUN
 *   node scripts/migrations/2026-05-25/recover-salvage-row-drivefileid.mjs --apply    # real run
 *
