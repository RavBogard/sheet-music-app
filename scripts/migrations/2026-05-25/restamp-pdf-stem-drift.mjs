 ...
 *
 * Sibling-of:
 *   - `scripts/migrations/2026-05-25/backfill-library-normalizedname.mjs` (own, `10f7f8183`) —
 ...
 * ## Usage
 *
 *   node scripts/migrations/2026-05-25/restamp-pdf-stem-drift.mjs            # DRY-RUN
 *   node scripts/migrations/2026-05-25/restamp-pdf-stem-drift.mjs --apply    # real run
 *
 * ## Auth
 *
