# `scripts/migrations/2026-05-25/restamp-normalizedname-drift.mjs` — RUNBOOK
...
| PHASE-3-REDRY | re-run pdf-stem-drift's `scripts/migrations/2026-05-25/restamp-pdf-stem-drift.mjs` (DRY-RUN) | confirm 0 cross-lane re-drift introduced |
...
node scripts/migrations/2026-05-25/restamp-normalizedname-drift.mjs \
...
node scripts/migrations/2026-05-25/restamp-normalizedname-drift.mjs --apply \
...
```bash
node scripts/migrations/2026-05-25/restamp-pdf-stem-drift.mjs \
