...
```bash
node scripts/migrations/2026-05-25/backfill-library-normalizedname.mjs \
...
```bash
node scripts/migrations/2026-05-25/backfill-library-normalizedname.mjs --apply \
...
- `scripts/migrations/2026-05-24/backfill-drive-id-on-library-index.mjs` (closest sibling shape)
- `scripts/migrations/2026-05-23/rebuild-setlist-fileids-denorm.mjs` (original DRY-RUN/--apply
