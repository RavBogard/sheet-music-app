 ...
 *
 * Sibling of scripts/migrations/2026-06-09/backfill-user-orgids.mjs — same auth path (.env.local SA cert
 ...
 *
 * Usage:
 *   node scripts/migrations/2026-06-09/backfill-assignment-orgids.mjs            # DRY-RUN (read-only)
 *   node scripts/migrations/2026-06-09/backfill-assignment-orgids.mjs --apply    # real run
 *
