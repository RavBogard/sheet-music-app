 ...
 *
 * Usage:
 *   node scripts/migrations/2026-06-09/fix-david-orgids-claim.mjs --email=david@example.com           # DRY-RUN
 *   node scripts/migrations/2026-06-09/fix-david-orgids-claim.mjs --email=david@example.com --apply   # real run
 *   node scripts/migrations/2026-06-09/fix-david-orgids-claim.mjs --uid=HTks9a8...           --apply
 */
