...
// script fills it.
//
// Run with: npx tsx scripts/migrations/2026-05-08/bootstrap-songs.ts [--dry-run|--apply|--rollback|--no-backstitch|--force|--help]
//
...
Usage:
  npx tsx scripts/migrations/2026-05-08/bootstrap-songs.ts                 Apply (back-stitch ON by default)
  npx tsx scripts/migrations/2026-05-08/bootstrap-songs.ts --dry-run       Enumerate planned writes; no changes
  npx tsx scripts/migrations/2026-05-08/bootstrap-songs.ts --no-backstitch Skip the songId back-stitch loop
  npx tsx scripts/migrations/2026-05-08/bootstrap-songs.ts --force         Re-run even if marker exists
  npx tsx scripts/migrations/2026-05-08/bootstrap-songs.ts --rollback      Restore pre-bootstrap state (sticky-memory safe)
  npx tsx scripts/migrations/2026-05-08/bootstrap-songs.ts --help          Show this help
