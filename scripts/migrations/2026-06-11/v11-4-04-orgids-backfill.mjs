...
// scripts/migrations/2026-06-10/v11-3-03-library-orphan-sweep.mjs + scripts/add-auth-domains.mjs.
//
// USAGE:
//   node scripts/migrations/2026-06-11/v11-4-04-orgids-backfill.mjs --diagnose         (read-only: distribution + would-change count)
//   node scripts/migrations/2026-06-11/v11-4-04-orgids-backfill.mjs                    (dry-run DEFAULT: per-user change-set + would-write snapshot, NO writes)
//   node scripts/migrations/2026-06-11/v11-4-04-orgids-backfill.mjs --apply --stamp "$(date -u +%Y%m%dT%H%M%SZ)"
//                                                                 (writes doc+claim both, writes a per-user rollback snapshot)
//   node scripts/migrations/2026-06-11/v11-4-04-orgids-backfill.mjs --rollback scripts/.backfill-snapshots/<file>.json
...
async function main() {
    ...
    console.log(`rollback with: node scripts/migrations/2026-06-11/v11-4-04-orgids-backfill.mjs --rollback ${snapshotPath}`)
}
