...
//
// USAGE:
//   node scripts/migrations/2026-06-14/v11-5-fix-track-mimetype-global.mjs            (dry-run — print plan only)
//   node scripts/migrations/2026-06-14/v11-5-fix-track-mimetype-global.mjs --apply    (commit the stamps)
