/**
 * Chat prompt helpers — extracted from src/app/api/chat/route.ts because
 * Next.js App Router route files can only export HTTP method handlers
 * (and specific route-segment config fields).
 *
 * S01 (v4.3 P2-01): sanitizeUserMessage + SYSTEM_PROMPT with injection-defense rules.
 */
import { TEMPLATE_LABELS } from "@/lib/liturgical-templates"

/**
 * Validate + sanitize a user-supplied chat message before it reaches
...
// System Prompt used for the 'Agent' persona.
