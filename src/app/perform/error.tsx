    ...
    return (
        <div className="h-[100dvh] flex flex-col items-center justify-center gap-4 px-6 text-center bg-black text-white">
            ...
            <div className="flex gap-3">
                <Button variant="outline" onClick={() => router.back()} className="border-border bg-transparent text-white hover:bg-gray-800">
                    Go Back
                </Button>
                <Button onClick={reset} className="bg-white text-black hover:bg-secondary">
                    Retry
                </Button>
            </div>
        </div>
