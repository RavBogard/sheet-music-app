        ...
        return generatePdfBlob({
            ...
            tracks: tracks.map(t => {
                ...
                return {
                    ...
                    // v70-01-01 Task 3: propagate fileName + mimeType so the
                    // print-pipeline image-skip guard works for both
                    // legacy (extension-bearing) and picker-bound (mimeType-bearing) tracks.
                    fileName: t.fileName,
                    mimeType: t.mimeType,
